...
![MVP iteration](images/mvp_journey.png){width=100%}
We should have a runnable MVP generated by CI/CD at every Sprint.

![MVP0](images/mvp.png){width=100%}
